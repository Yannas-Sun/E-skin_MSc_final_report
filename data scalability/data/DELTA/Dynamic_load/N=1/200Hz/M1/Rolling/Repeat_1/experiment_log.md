# Experiment 20260907_053858_001637

Started: 2026-09-07T05:38:58.001637+01:00
Actual duration: 40.000818 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 209734.3883127,
    "observed_at_monotonic": 209734.3958178,
    "window_span_seconds": 1.487869500007946,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 299,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
  ...
  "module_detection_at_worker_start": {
    ...
    "last_packet_monotonic": 209734.3883127,
    "observed_at_monotonic": 209734.3959823,
    "window_span_seconds": 1.487869500007946,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 299,
...
- full_run: CHECK REQUIRED; 40.000818 s; 8012 valid MUL1; 8012/8012 target updates.
  Review reasons: initial_delta_prefix_cache_not_verifiable_from_file, unassigned_raw_bytes_in_full_capture.
- main: PASS; 30.000818 s; 6010 valid MUL1; 6010/6010 target updates.
  Review reasons: none.
