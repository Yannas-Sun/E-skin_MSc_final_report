# Experiment 20260907_054018_056649

Started: 2026-09-07T05:40:18.056649+01:00
Actual duration: 40.000601 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_record": {
    ...
    "last_packet_monotonic": 209734.3785645,
    "observed_at_monotonic": 209734.3785645,
    "window_span_seconds": 1.4918210999749135,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 301,
  ...
  "observed_mul1_rate_at_record_Hz": 200.1255514019782,
  ...
  "batch_id": "BATCH_b940a6e92ebc4a608a29b6c2ca628cd2",
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 209814.4228107,
    "observed_at_monotonic": 209814.4486874,
    "window_span_seconds": 1.473063599987654,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 296,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: CHECK REQUIRED; 40.000601 s; 8020 valid MUL1; 8020/8020 target updates.
  Review reasons: initial_delta_prefix_cache_not_verifiable_from_file.
- main: PASS; 30.000601 s; 6012 valid MUL1; 6012/6012 target updates.
  Review reasons: none.
