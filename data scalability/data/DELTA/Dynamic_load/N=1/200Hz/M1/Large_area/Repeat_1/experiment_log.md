# Experiment 20260907_040621_371357

Started: 2026-09-07T04:06:21.371357+01:00
Actual duration: 40.002603 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_record": {
    ...
    "last_packet_monotonic": 204178.0287079,
    "observed_at_monotonic": 204178.0287079,
    "window_span_seconds": 1.4966243999951985,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 301,
  ...
  "observed_mul1_rate_at_record_Hz": 200.5862307192181,
  ...
  "batch_id": "BATCH_b85c7425a5b149dabf8cd9a9dcb33094",
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 204178.0437627,
    "observed_at_monotonic": 204178.0516125,
    "window_span_seconds": 1.4917500999872573,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 300,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
  ...
  "module_detection_at_worker_start": {
    ...
    "last_packet_monotonic": 204178.0437627,
    "observed_at_monotonic": 204178.0517264,
    "window_span_seconds": 1.4917500999872573,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 300,
  ...
  "pre_record_commands": [
    {
      "command": "MODE FULL",
      "source": "user",
      "sent_at": "2026-09-07T02:49:16.567123+01:00"
    },
    {
      "command": "MODE DELTA",
      "source": "user",
      "sent_at": "2026-09-07T04:06:09.610758+01:00"
    }
  ],
  "stream_start_offset": 1673845781,
  ...
  "load_label": "large_area"
}
```

## Scope checks

- full_run: CHECK REQUIRED; 40.002603 s; 8002 valid MUL1; 8002/8002 target updates.
  Review reasons: initial_delta_prefix_cache_not_verifiable_from_file.
- main: PASS; 30.002603 s; 5998 valid MUL1; 5998/5998 target updates.
  Review reasons: none.
