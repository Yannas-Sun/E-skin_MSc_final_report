# Experiment 20260907_052101_230925

Started: 2026-09-07T05:21:01.230925+01:00
Actual duration: 40.000043 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_record": {
    ...
    "last_packet_monotonic": 208577.5755757,
    "observed_at_monotonic": 208577.5755757,
    "window_span_seconds": 1.4917037000122946,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 301,
  ...
  "observed_mul1_rate_at_record_Hz": 198.5664889417601,
  ...
  "batch_id": "BATCH_01a68db283d446ceb790e6516fb50a79",
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 208657.619296,
    "observed_at_monotonic": 208657.654343,
    "window_span_seconds": 1.4619570999930147,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 294,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: CHECK REQUIRED; 40.000043 s; 8023 valid MUL1; 8023/8023 target updates.
  Review reasons: initial_delta_prefix_cache_not_verifiable_from_file.
- main: PASS; 30.000043 s; 6013 valid MUL1; 6013/6013 target updates.
  Review reasons: none.
