# Experiment 20260907_060147_020562

Started: 2026-09-07T06:01:47.020562+01:00
Actual duration: 40.003565 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 211103.3794583,
    "observed_at_monotonic": 211103.3868743,
    "window_span_seconds": 1.489121700025862,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 299,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
  ...
  "module_detection_at_worker_start": {
    ...
    "last_packet_monotonic": 211103.3794583,
    "observed_at_monotonic": 211103.3871367,
    "window_span_seconds": 1.489121700025862,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 299,
...
- full_run: CHECK REQUIRED; 40.003565 s; 7979 valid MUL1; 31916/31916 target updates.
  Review reasons: initial_delta_prefix_cache_not_verifiable_from_file, unassigned_raw_bytes_in_full_capture.
- main: PASS; 30.003565 s; 5978 valid MUL1; 23912/23912 target updates.
  Review reasons: none.
