# Experiment 20260907_013212_470890

Started: 2026-09-07T01:32:12.470890+01:00
Actual duration: 40.000949 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_record": {
    ...
    "last_packet_monotonic": 194889.1631223,
    "observed_at_monotonic": 194889.1631223,
    "window_span_seconds": 1.4980088000011165,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 301,
  ...
  "observed_mul1_rate_at_record_Hz": 199.31898681821357,
  ...
  "batch_id": "BATCH_2f989cb36d334ac587213f1a297dc628",
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 194929.1764824,
    "observed_at_monotonic": 194929.2426305,
    "window_span_seconds": 1.4338335000211373,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 288,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: CHECK REQUIRED; 40.000949 s; 8018 valid MUL1; 8018/8018 target updates.
  Review reasons: initial_delta_prefix_cache_not_verifiable_from_file.
- main: PASS; 30.000949 s; 6005 valid MUL1; 6005/6005 target updates.
  Review reasons: none.
