# Experiment 20260907_013443_415053

Started: 2026-09-07T01:34:43.415053+01:00
Actual duration: 40.003548 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 195080.1153429,
    "observed_at_monotonic": 195080.1842367,
    "window_span_seconds": 1.4290441000193823,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 285,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: CHECK REQUIRED; 40.003548 s; 8031 valid MUL1; 8031/8031 target updates.
  Review reasons: initial_delta_prefix_cache_not_verifiable_from_file.
- main: PASS; 30.003548 s; 6011 valid MUL1; 6011/6011 target updates.
  Review reasons: none.
