# Experiment 20260907_013744_540625

Started: 2026-09-07T01:37:44.540625+01:00
Actual duration: 40.000496 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_record": {
    ...
    "last_packet_monotonic": 195181.1223383,
    "observed_at_monotonic": 195181.1223383,
    "window_span_seconds": 1.4986369999824092,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 302,
  ...
  "observed_mul1_rate_at_record_Hz": 200.17878654422182,
  ...
  "batch_id": "BATCH_b2fdee22f9b94a5f97759036b00fa981",
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 195261.2233954,
    "observed_at_monotonic": 195261.3078733,
    "window_span_seconds": 1.4129035000223666,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 285,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: CHECK REQUIRED; 40.000496 s; 8023 valid MUL1; 8023/8023 target updates.
  Review reasons: initial_delta_prefix_cache_not_verifiable_from_file.
- main: PASS; 30.000496 s; 6005 valid MUL1; 6005/6005 target updates.
  Review reasons: none.
