# Experiment 20260907_014835_279154

Started: 2026-09-07T01:48:35.279154+01:00
Actual duration: 40.004205 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 195911.985592,
    "observed_at_monotonic": 195912.0386639,
    "window_span_seconds": 1.4442502000019886,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 290,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: CHECK REQUIRED; 40.004205 s; 8013 valid MUL1; 16026/16026 target updates.
  Review reasons: initial_delta_prefix_cache_not_verifiable_from_file, unassigned_raw_bytes_in_full_capture.
- main: PASS; 30.004205 s; 6002 valid MUL1; 12004/12004 target updates.
  Review reasons: none.
