# Experiment 20260907_015026_779606

Started: 2026-09-07T01:50:26.779606+01:00
Actual duration: 40.000074 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 196023.4210572,
    "observed_at_monotonic": 196023.5291552,
    "window_span_seconds": 1.3900612000143155,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 276,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: CHECK REQUIRED; 40.000074 s; 8033 valid MUL1; 16066/16066 target updates.
  Review reasons: initial_delta_prefix_cache_not_verifiable_from_file.
- main: PASS; 30.000074 s; 6005 valid MUL1; 12010/12010 target updates.
  Review reasons: none.
