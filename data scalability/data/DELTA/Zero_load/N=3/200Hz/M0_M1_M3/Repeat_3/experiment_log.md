# Experiment 20260907_020439_495918

Started: 2026-09-07T02:04:39.495918+01:00
Actual duration: 40.000537 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 196876.1957161,
    "observed_at_monotonic": 196876.2449038,
    "window_span_seconds": 1.4475092999928165,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 291,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: CHECK REQUIRED; 40.000537 s; 8015 valid MUL1; 24045/24045 target updates.
  Review reasons: initial_delta_prefix_cache_not_verifiable_from_file.
- main: PASS; 30.000537 s; 6006 valid MUL1; 18018/18018 target updates.
  Review reasons: none.
