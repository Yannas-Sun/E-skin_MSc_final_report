# Experiment 20260907_015849_721923

Started: 2026-09-07T01:58:49.721923+01:00
Actual duration: 40.000820 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_record": {
    ...
    "last_packet_monotonic": 196486.36208,
    "observed_at_monotonic": 196486.36208,
    "window_span_seconds": 1.4978919999848586,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 301,
  ...
  "observed_mul1_rate_at_record_Hz": 200.61752269414313,
  ...
  "batch_id": "BATCH_4938ea384f0d4a39bc04cb6a3bb282be",
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 196526.3742092,
    "observed_at_monotonic": 196526.4722422,
    "window_span_seconds": 1.3973160000168718,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 281,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: CHECK REQUIRED; 40.000820 s; 8028 valid MUL1; 24084/24084 target updates.
  Review reasons: initial_delta_prefix_cache_not_verifiable_from_file.
- main: PASS; 30.000820 s; 6007 valid MUL1; 18021/18021 target updates.
  Review reasons: none.
