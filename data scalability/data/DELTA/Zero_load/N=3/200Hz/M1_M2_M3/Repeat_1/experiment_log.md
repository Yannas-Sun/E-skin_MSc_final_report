# Experiment 20260907_015809_623056

Started: 2026-09-07T01:58:09.623056+01:00
Actual duration: 40.000418 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 196486.3670066,
    "observed_at_monotonic": 196486.3757234,
    "window_span_seconds": 1.488097099994775,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 299,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
  ...
  "module_detection_at_worker_start": {
    ...
    "last_packet_monotonic": 196486.3670066,
    "observed_at_monotonic": 196486.3759459,
    "window_span_seconds": 1.488097099994775,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 299,
...
- full_run: CHECK REQUIRED; 40.000418 s; 8009 valid MUL1; 24027/24027 target updates.
  Review reasons: initial_delta_prefix_cache_not_verifiable_from_file, unassigned_raw_bytes_in_full_capture.
- main: PASS; 30.000418 s; 6007 valid MUL1; 18021/18021 target updates.
  Review reasons: none.
