# Experiment 20260907_020708_105510

Started: 2026-09-07T02:07:08.105510+01:00
Actual duration: 40.003017 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 197024.7972247,
    "observed_at_monotonic": 197024.8531201,
    "window_span_seconds": 1.443814600002952,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 290,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: CHECK REQUIRED; 40.003017 s; 8019 valid MUL1; 24057/24057 target updates.
  Review reasons: initial_delta_prefix_cache_not_verifiable_from_file.
- main: PASS; 30.003017 s; 6006 valid MUL1; 18018/18018 target updates.
  Review reasons: none.
