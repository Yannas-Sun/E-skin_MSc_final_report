# Experiment 20260907_020547_996772

Started: 2026-09-07T02:05:47.996772+01:00
Actual duration: 40.003333 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 196944.737434,
    "observed_at_monotonic": 196944.7442708,
    "window_span_seconds": 1.4927411999960896,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 300,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
  ...
  "module_detection_at_worker_start": {
    ...
    "last_packet_monotonic": 196944.737434,
    "observed_at_monotonic": 196944.7444335,
    "window_span_seconds": 1.4927411999960896,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 300,
...
- full_run: CHECK REQUIRED; 40.003333 s; 8008 valid MUL1; 24024/24024 target updates.
  Review reasons: initial_delta_prefix_cache_not_verifiable_from_file, unassigned_raw_bytes_in_full_capture.
- main: PASS; 30.003333 s; 6007 valid MUL1; 18021/18021 target updates.
  Review reasons: none.
