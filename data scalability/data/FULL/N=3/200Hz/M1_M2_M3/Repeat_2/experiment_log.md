# Experiment 20260907_003339_025463

Started: 2026-09-07T00:33:39.025463+01:00
Actual duration: 40.002446 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 191415.7750887,
    "observed_at_monotonic": 191415.8730973,
    "window_span_seconds": 1.3951129000051878,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 284,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
  ...
  "stream_start_offset": 2007949190,
...
- full_run: CHECK REQUIRED; 40.002446 s; 8031 valid MUL1; 24093/24093 target updates.
  Review reasons: unassigned_raw_bytes_in_full_capture.
- main: PASS; 30.002446 s; 6008 valid MUL1; 18024/18024 target updates.
  Review reasons: none.
