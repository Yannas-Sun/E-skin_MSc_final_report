# Experiment 20260907_005108_797842

Started: 2026-09-07T00:51:08.797842+01:00
Actual duration: 40.006371 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 192465.5474433,
    "observed_at_monotonic": 192465.6179163,
    "window_span_seconds": 1.4182523999770638,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 286,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: CHECK REQUIRED; 40.006371 s; 8018 valid MUL1; 24054/24054 target updates.
  Review reasons: unassigned_raw_bytes_in_full_capture.
- main: PASS; 30.006371 s; 6002 valid MUL1; 18006/18006 target updates.
  Review reasons: none.
