# Experiment 20260907_000253_764287

Started: 2026-09-07T00:02:53.764287+01:00
Actual duration: 40.005409 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 189570.6803047,
    "observed_at_monotonic": 189570.7024995,
    "window_span_seconds": 1.474047800002154,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 296,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: CHECK REQUIRED; 40.005409 s; 7998 valid MUL1; 23994/23994 target updates.
  Review reasons: unassigned_raw_bytes_in_full_capture.
- main: PASS; 30.005409 s; 6005 valid MUL1; 18015/18015 target updates.
  Review reasons: none.
