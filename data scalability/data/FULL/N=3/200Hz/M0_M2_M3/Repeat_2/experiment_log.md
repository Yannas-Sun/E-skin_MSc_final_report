# Experiment 20260907_001751_034069

Started: 2026-09-07T00:17:51.034069+01:00
Actual duration: 40.003180 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 190467.8804822,
    "observed_at_monotonic": 190467.92527,
    "window_span_seconds": 1.4524841000093147,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 292,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
  ...
  "stream_start_offset": 1423748099,
...
- full_run: CHECK REQUIRED; 40.003180 s; 8015 valid MUL1; 24045/24045 target updates.
  Review reasons: unassigned_raw_bytes_in_full_capture.
- main: PASS; 30.003180 s; 6005 valid MUL1; 18015/18015 target updates.
  Review reasons: none.
