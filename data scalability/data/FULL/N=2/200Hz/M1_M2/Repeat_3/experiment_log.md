# Experiment 20260906_233520_115774

Started: 2026-09-06T23:35:20.115774+01:00
Actual duration: 40.003140 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 187917.1582281,
    "observed_at_monotonic": 187917.1831386,
    "window_span_seconds": 1.4724950999952853,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 296,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: CHECK REQUIRED; 40.003140 s; 8014 valid MUL1; 16028/16028 target updates.
  Review reasons: unassigned_raw_bytes_in_full_capture.
- main: PASS; 30.003140 s; 6007 valid MUL1; 12014/12014 target updates.
  Review reasons: none.
