# Experiment 20260906_233440_083230

Started: 2026-09-06T23:34:40.083230+01:00
Actual duration: 40.000591 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 187877.1163458,
    "observed_at_monotonic": 187877.1555153,
    "window_span_seconds": 1.4586762999824714,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 293,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: CHECK REQUIRED; 40.000591 s; 8015 valid MUL1; 16030/16030 target updates.
  Review reasons: unassigned_raw_bytes_in_full_capture.
- main: PASS; 30.000591 s; 6007 valid MUL1; 12014/12014 target updates.
  Review reasons: none.
