# Experiment 20260906_234419_667943

Started: 2026-09-06T23:44:19.667943+01:00
Actual duration: 40.004242 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 188456.6388549,
    "observed_at_monotonic": 188456.6860727,
    "window_span_seconds": 1.4490903999831062,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 291,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: CHECK REQUIRED; 40.004242 s; 8018 valid MUL1; 16036/16036 target updates.
  Review reasons: unassigned_raw_bytes_in_full_capture.
- main: PASS; 30.004242 s; 6007 valid MUL1; 12014/12014 target updates.
  Review reasons: none.
