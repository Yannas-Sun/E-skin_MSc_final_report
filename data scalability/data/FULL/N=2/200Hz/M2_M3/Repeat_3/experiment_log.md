# Experiment 20260906_234459_699129

Started: 2026-09-06T23:44:59.699129+01:00
Actual duration: 40.003132 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 188496.6873972,
    "observed_at_monotonic": 188496.7138885,
    "window_span_seconds": 1.4683967000164557,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 295,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: CHECK REQUIRED; 40.003132 s; 8012 valid MUL1; 16024/16024 target updates.
  Review reasons: unassigned_raw_bytes_in_full_capture.
- main: PASS; 30.003132 s; 6006 valid MUL1; 12012/12012 target updates.
  Review reasons: none.
