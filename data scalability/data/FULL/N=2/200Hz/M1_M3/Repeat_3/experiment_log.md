# Experiment 20260906_234055_124089

Started: 2026-09-06T23:40:55.124089+01:00
Actual duration: 40.002008 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 188252.1197518,
    "observed_at_monotonic": 188252.1621448,
    "window_span_seconds": 1.4570596999838017,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 293,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: CHECK REQUIRED; 40.002008 s; 8023 valid MUL1; 16046/16046 target updates.
  Review reasons: unassigned_raw_bytes_in_full_capture.
- main: PASS; 30.002008 s; 6013 valid MUL1; 12026/12026 target updates.
  Review reasons: none.
