# Experiment 20260906_234631_872633

Started: 2026-09-06T23:46:31.872633+01:00
Actual duration: 40.003282 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_record": {
    ...
    "last_packet_monotonic": 188588.8656555,
    "observed_at_monotonic": 188588.8656555,
    "window_span_seconds": 1.4998778000008315,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 301,
  ...
  "observed_mul1_rate_at_record_Hz": 200.11614701029603,
  ...
  "batch_id": "BATCH_011a17c511724e4c87760f72a6433c4a",
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 188588.8705623,
    "observed_at_monotonic": 188588.8780249,
    "window_span_seconds": 1.486104499985231,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 300,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
  ...
  "module_detection_at_worker_start": {
    ...
    "last_packet_monotonic": 188588.8705623,
    "observed_at_monotonic": 188588.8782483,
    "window_span_seconds": 1.486104499985231,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 300,
  ...
  "pre_record_commands": [
    {
      "command": "MODE DELTA",
      "source": "user",
      "sent_at": "2026-09-06T23:42:48.105814+01:00"
    },
    {
      "command": "MODE FULL",
      "source": "user",
...
- full_run: CHECK REQUIRED; 40.003282 s; 8004 valid MUL1; 16008/16008 target updates.
  Review reasons: unassigned_raw_bytes_in_full_capture.
- main: PASS; 30.003282 s; 6003 valid MUL1; 12006/12006 target updates.
  Review reasons: none.
