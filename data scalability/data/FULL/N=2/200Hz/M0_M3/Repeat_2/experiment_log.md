# Experiment 20260906_233030_242504

Started: 2026-09-06T23:30:30.242504+01:00
Actual duration: 40.000130 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 187627.3114051,
    "observed_at_monotonic": 187627.3400986,
    "window_span_seconds": 1.4703947999805678,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 295,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: PASS; 40.000130 s; 8011 valid MUL1; 16022/16022 target updates.
  Review reasons: none.
- main: PASS; 30.000130 s; 6005 valid MUL1; 12010/12010 target updates.
  Review reasons: none.
