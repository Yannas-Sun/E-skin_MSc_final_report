# Experiment 20260906_232205_264776

Started: 2026-09-06T23:22:05.264776+01:00
Actual duration: 40.006758 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 187122.3632275,
    "observed_at_monotonic": 187122.370914,
    "window_span_seconds": 1.4895585000049323,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 299,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
  ...
  "module_detection_at_worker_start": {
    ...
    "last_packet_monotonic": 187122.3632275,
    "observed_at_monotonic": 187122.3710405,
    "window_span_seconds": 1.4895585000049323,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 299,
...
- full_run: CHECK REQUIRED; 40.006758 s; 8004 valid MUL1; 16008/16008 target updates.
  Review reasons: unassigned_raw_bytes_in_full_capture.
- main: PASS; 30.006758 s; 6003 valid MUL1; 12006/12006 target updates.
  Review reasons: none.
