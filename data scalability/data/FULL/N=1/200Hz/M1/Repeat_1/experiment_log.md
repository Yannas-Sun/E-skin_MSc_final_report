# Experiment 20260906_230200_451593

Started: 2026-09-06T23:02:00.451593+01:00
Actual duration: 40.003054 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 185917.5495439,
    "observed_at_monotonic": 185917.5543796,
    "window_span_seconds": 1.4921880000038072,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 300,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
  ...
  "module_detection_at_worker_start": {
    ...
    "last_packet_monotonic": 185917.5495439,
    "observed_at_monotonic": 185917.554472,
    "window_span_seconds": 1.4921880000038072,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 300,
...
- full_run: CHECK REQUIRED; 40.003054 s; 8014 valid MUL1; 8014/8014 target updates.
  Review reasons: unassigned_raw_bytes_in_full_capture.
- main: PASS; 30.003054 s; 6010 valid MUL1; 6010/6010 target updates.
  Review reasons: none.
