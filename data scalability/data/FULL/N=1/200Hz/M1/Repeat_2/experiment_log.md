# Experiment 20260906_230240_486802

Started: 2026-09-06T23:02:40.486802+01:00
Actual duration: 40.000114 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_record": {
    ...
    "last_packet_monotonic": 185917.5495439,
    "observed_at_monotonic": 185917.5495439,
    "window_span_seconds": 1.497287200007122,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 301,
  ...
  "observed_mul1_rate_at_record_Hz": 200.70768932103425,
  ...
  "batch_id": "BATCH_d49624f461e24a80b1176d3a6386840c",
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 185957.5544994,
    "observed_at_monotonic": 185957.5899441,
    "window_span_seconds": 1.4595636999874841,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 293,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: CHECK REQUIRED; 40.000114 s; 8023 valid MUL1; 8023/8023 target updates.
  Review reasons: unassigned_raw_bytes_in_full_capture.
- main: PASS; 30.000114 s; 6012 valid MUL1; 6012/6012 target updates.
  Review reasons: none.
