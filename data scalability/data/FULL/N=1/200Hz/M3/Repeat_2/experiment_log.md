# Experiment 20260906_230949_124162

Started: 2026-09-06T23:09:49.124162+01:00
Actual duration: 40.008811 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 186386.192513,
    "observed_at_monotonic": 186386.227808,
    "window_span_seconds": 1.4592169999959879,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 294,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: CHECK REQUIRED; 40.008811 s; 8020 valid MUL1; 8020/8020 target updates.
  Review reasons: unassigned_raw_bytes_in_full_capture.
- main: PASS; 30.008811 s; 6010 valid MUL1; 6010/6010 target updates.
  Review reasons: none.
