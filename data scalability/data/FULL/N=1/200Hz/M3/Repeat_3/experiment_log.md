# Experiment 20260906_231029_180830

Started: 2026-09-06T23:10:29.180830+01:00
Actual duration: 40.000340 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 186426.2259543,
    "observed_at_monotonic": 186426.2839685,
    "window_span_seconds": 1.4375040000013541,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 289,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: CHECK REQUIRED; 40.000340 s; 8025 valid MUL1; 8025/8025 target updates.
  Review reasons: unassigned_raw_bytes_in_full_capture.
- main: PASS; 30.000340 s; 6011 valid MUL1; 6011/6011 target updates.
  Review reasons: none.
