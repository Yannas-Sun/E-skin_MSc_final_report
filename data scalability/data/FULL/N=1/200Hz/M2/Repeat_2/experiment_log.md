# Experiment 20260906_230525_193234

Started: 2026-09-06T23:05:25.193234+01:00
Actual duration: 40.003198 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_record": {
    ...
    "last_packet_monotonic": 186082.2489849,
    "observed_at_monotonic": 186082.2489849,
    "window_span_seconds": 1.4979178000066895,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 301,
  ...
  "observed_mul1_rate_at_record_Hz": 200.37003660159473,
  ...
  "batch_id": "BATCH_bd456b8e61be480ca230158c349c63e4",
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 186122.2535939,
    "observed_at_monotonic": 186122.2935682,
    "window_span_seconds": 1.4580959000159055,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 293,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: CHECK REQUIRED; 40.003198 s; 8016 valid MUL1; 8016/8016 target updates.
  Review reasons: unassigned_raw_bytes_in_full_capture.
- main: PASS; 30.003198 s; 6006 valid MUL1; 6006/6006 target updates.
  Review reasons: none.
