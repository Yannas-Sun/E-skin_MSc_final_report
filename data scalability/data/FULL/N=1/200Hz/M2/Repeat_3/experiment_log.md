# Experiment 20260906_230605_248880

Started: 2026-09-06T23:06:05.248880+01:00
Actual duration: 40.000710 s; requested: 40 s; settle: 10 s.
...
```json
{
  ...
  "module_detection_at_repeat_start": {
    ...
    "last_packet_monotonic": 186162.2970336,
    "observed_at_monotonic": 186162.3489631,
    "window_span_seconds": 1.443697600014275,
    "window_seconds": 1.5,
    "stale_seconds": 0.5,
    "packet_count": 290,
    "limitation": "No response cannot establish whether a board is physically attached. The recent union can retain a briefly missing slot; recording freezes the set."
...
- full_run: CHECK REQUIRED; 40.000710 s; 8018 valid MUL1; 8018/8018 target updates.
  Review reasons: unassigned_raw_bytes_in_full_capture.
- main: PASS; 30.000710 s; 6006 valid MUL1; 6006/6006 target updates.
  Review reasons: none.
