...
SNAPSHOT = ("20260907_050453_154588","20260907_050533_183636","20260907_050613_222506")
...
def main():
    ...
    for rid in SNAPSHOT:
        ...
        run["actual_condition_source"] = "user_confirmed_same_large_area_dynamic_loading_as_previous_batch; original metadata preserved"
    ...
    output = {"schema_version":1,"audit_at":datetime.now().astimezone().isoformat(),"snapshot_run_ids":list(SNAPSHOT),
              ...
              "condition_note":"metadata records zero_load in error; user explicitly confirmed large_area dynamic loading, same as previous batch; original metadata preserved",
