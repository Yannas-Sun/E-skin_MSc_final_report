"""Apply the previously checked read-only timing audit to the new fixed batch."""
import hashlib
...
IDS = ("20260907_051941_159689", "20260907_052021_196300", "20260907_052101_230925")
...
def main():
    ...
    result["definitions"]["condition"] = "Recorded zero_load; user specified large-area repeated pressing/releasing. See condition_correction.json"
