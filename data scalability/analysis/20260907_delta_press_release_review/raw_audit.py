...
SNAPSHOT = ("20260907_051941_159689","20260907_052021_196300","20260907_052101_230925")
...
def main():
    ...
    for rid in SNAPSHOT:
        ...
        run["actual_description"] = "大面积反复按压、释放"
        run["actual_condition_source"] = "user_confirmed_large_area_repeated_press_and_release; original metadata preserved"
    ...
    output = {"schema_version":1,"audit_at":datetime.now().astimezone().isoformat(),"snapshot_run_ids":list(SNAPSHOT),
              ...
              "condition_note":"metadata records zero_load; user explicitly described large-area repeated pressing and release; original metadata preserved",
    ...
    lines = ["# 大面积反复按压、释放三条 DELTA 记录：独立原始协议审计", "",
